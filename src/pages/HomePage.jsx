  ...
  return (
    <>
      ...
      <header className="max-w-4xl mx-auto px-6 md:px-8 text-center mt-0 md:mt-8 mb-20 md:mb-28 flex flex-col items-center">
        ...
        >
          <span className={darkMode ? 'text-purple-400' : 'text-purple-600'}>{typedVerb}</span>
          <span className={`inline-block w-[3px] h-[0.75em] ml-1 align-baseline animate-pulse ${darkMode ? 'bg-purple-400' : 'bg-purple-600'}`} />
          {' '}{t('home', 'hero')[0]} <br />
      ...
      <section className="max-w-2xl mx-auto px-6 md:px-8 text-center mb-16 md:mb-24 pt-4 md:pt-6 flex flex-col items-center">
        ...
        <p
          style={fontSans}
          className={`font-light text-base md:text-lg not-italic leading-relaxed mb-8 max-w-2xl ${
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-8">
          <div className="text-center mb-20 md:mb-24 flex flex-col items-center">
            <h2 style={fontSerif} className={`text-4xl md:text-5xl mb-6 ${textMain}`}>
              {t('home', 'manifestTitle')} <span className={darkMode ? 'text-purple-400' : 'text-purple-600'}>{t('home', 'manifestTodo')}</span>
            </h2>
            <p
