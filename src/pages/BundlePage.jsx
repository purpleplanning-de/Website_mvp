...
export default function BundlePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-8 md:px-12 mt-12 md:mt-16 mb-20 md:mb-28 animate-in fade-in text-center min-h-[40vh] flex flex-col justify-start pt-40">
      {!isResult ? (
        <>
