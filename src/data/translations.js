export const translations = {
  de: {
    offline: {
      ...
      noConnection: 'Keine Internetverbindung. Bitte überprüfe dein Netzwerk.',
    },
    nav: {
      shop: 'Shop',
    ...
    notFound: {
      seoTitle: 'Seite nicht gefunden | Purple Planning',
      seoDescription: 'Diese Seite existiert leider nicht. Finde deinen Weg zurück zu Purple Planning.',
      title: 'Oops! Diese Seite ist',
      titleAccent: 'verloren gegangen',
      description: 'Die Seite, die du suchst, existiert nicht oder wurde verschoben. Aber keine Sorge – wir helfen dir, den richtigen Weg zu finden!',
      linkHome: 'Startseite',
      linkHomeDesc: 'Zurück zur Homepage',
      linkShop: 'Shop',
      linkShopDesc: 'Unsere Produkte entdecken',
      linkBundle: 'System Finder',
      linkBundleDesc: 'Dein perfektes System finden',
      linkBlog: 'Blog',
      linkBlogDesc: 'Inspiration & Tipps',
      linkContact: 'Kontakt',
      linkContactDesc: 'Schreib uns eine Nachricht',
      back: 'Zurück zur vorherigen Seite',
    },
    cookie: {
      title: 'Wir respektieren deine Privatsphäre',
      description: 'Wir verwenden Cookies, um dir die bestmögliche Erfahrung zu bieten. Technisch notwendige Cookies sind immer aktiv. Optionale Cookies helfen uns, die Seite zu verbessern.',
      ...
      necessary: 'Notwendig',
      necessaryDesc: 'Technisch erforderlich für Warenkorb, Theme und Sprachauswahl.',
      analytics: 'Analyse',
      analyticsDesc: 'Hilft uns zu verstehen, wie Besucher die Seite nutzen.',
      marketing: 'Marketing',
      marketingDesc: 'Ermöglicht personalisierte Inhalte und Empfehlungen.',
      back: 'Zurück',
  ...
  en: {
    ...
    notFound: {
      seoTitle: 'Page not found | Purple Planning',
      seoDescription: "This page doesn't exist. Find your way back to Purple Planning.",
      title: 'Oops! This page is',
      titleAccent: 'lost',
      description: "The page you're looking for doesn't exist or has been moved. But don't worry – we'll help you find the right way!",
      linkHome: 'Home',
      linkHomeDesc: 'Back to homepage',
      linkShop: 'Shop',
      linkShopDesc: 'Discover our products',
      linkBundle: 'System Finder',
      linkBundleDesc: 'Find your perfect system',
      linkBlog: 'Blog',
      linkBlogDesc: 'Inspiration & tips',
      linkContact: 'Contact',
      linkContactDesc: 'Send us a message',
      back: 'Back to previous page',
    },
    cookie: {
      title: 'We respect your privacy',
      description: 'We use cookies to give you the best experience. Technically necessary cookies are always active. Optional cookies help us improve the site.',
      ...
      necessary: 'Necessary',
      necessaryDesc: 'Technically required for cart, theme, and language selection.',
      analytics: 'Analytics',
      analyticsDesc: 'Helps us understand how visitors use the site.',
      marketing: 'Marketing',
      marketingDesc: 'Enables personalized content and recommendations.',
      back: 'Back',
  ...
  se: {
    offline: {
      backOnline: 'Du är online igen!',
      noConnection: 'Ingen internetanslutning. Kontrollera ditt nätverk.',
    },
    nav: {
      shop: 'Butik',
    ...
    notFound: {
      seoTitle: 'Sidan hittades inte | Purple Planning',
      seoDescription: 'Den här sidan finns inte. Hitta tillbaka till Purple Planning.',
      title: 'Hoppsan! Den här sidan är',
      titleAccent: 'borttappad',
      description: 'Sidan du letar efter finns inte eller har flyttats. Men oroa dig inte – vi hjälper dig hitta rätt!',
      linkHome: 'Startsida',
      linkHomeDesc: 'Tillbaka till startsidan',
      linkShop: 'Butik',
      linkShopDesc: 'Upptäck våra produkter',
      linkBundle: 'Systemhittare',
      linkBundleDesc: 'Hitta ditt perfekta system',
      linkBlog: 'Blogg',
      linkBlogDesc: 'Inspiration & tips',
      linkContact: 'Kontakt',
      linkContactDesc: 'Skicka oss ett meddelande',
      back: 'Tillbaka till föregående sida',
    },
    cookie: {
      title: 'Vi respekterar din integritet',
      description: 'Vi använder cookies för att ge dig bästa möjliga upplevelse. Tekniskt nödvändiga cookies är alltid aktiva. Valfria cookies hjälper oss att förbättra sidan.',
      privacyLink: 'Integritetspolicy',
      settings: 'Inställningar',
      declineOptional: 'Endast nödvändiga',
      acceptAll: 'Acceptera alla',
      settingsTitle: 'Cookie-inställningar',
      necessary: 'Nödvändiga',
      necessaryDesc: 'Tekniskt nödvändiga för varukorg, tema och språkval.',
      analytics: 'Analys',
      analyticsDesc: 'Hjälper oss förstå hur besökare använder sidan.',
      marketing: 'Marknadsföring',
      marketingDesc: 'Möjliggör personligt innehåll och rekommendationer.',
      back: 'Tillbaka',
      saveSettings: 'Spara val',
    },
    footer: {
      aboutUs: 'Om oss',
    },
